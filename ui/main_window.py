...
# [MainWindow._copy_lift_data_to_clipboard -> Copies performance analysis data to the clipboard -> dependent functions are None]
# [MainWindow._populate_variable_importance_tab -> Populates the variable importance tab with evaluation results -> dependent functions are _create_classification_report_table, _add_feature_importance_display, _copy_analysis_to_clipboard]
# [MainWindow._create_classification_report_table -> Creates a formatted table for the classification report -> dependent functions are None]
# [MainWindow._add_feature_importance_display -> Adds a feature importance display to a layout -> dependent functions are None]
# [MainWindow._copy_analysis_to_clipboard -> Copies analysis data to the clipboard -> dependent functions are None]
# [MainWindow._populate_node_report_tab -> Populates the node report tab with a comprehensive analysis -> dependent functions are _get_standard_header_font, _get_standard_body_font, _refresh_node_report_tab, _copy_node_report_to_clipboard, _export_node_report_to_excel_with_progress]
# [MainWindow._create_node_report_tab -> Creates the structure for the node report tab -> dependent functions are _get_standard_header_font, _get_standard_body_font]
# [MainWindow._refresh_node_report_tab -> Refreshes the node report tab with current data -> dependent functions are _populate_node_report_tab]
# [MainWindow._copy_node_report_to_clipboard -> Copies selected rows from the node report to the clipboard -> dependent functions are None]
# [MainWindow._export_node_report_to_excel_with_progress -> Exports the node report to an Excel file with a progress dialog -> dependent functions are export_to_excel]
# [MainWindow._export_node_report_to_excel -> A legacy method for exporting the node report to Excel -> dependent functions are _export_node_report_to_excel_with_progress]
# [MainWindow._get_latest_evaluation_results -> Gets the latest evaluation results from the workflow engine -> dependent functions are None]
# [MainWindow._create_roc_curve_plot -> Creates a widget for the ROC curve plot -> dependent functions are None]
# [MainWindow._copy_metrics_to_clipboard -> Copies metrics to the clipboard -> dependent functions are None]
# [MainWindow.show_filter_dialog -> Shows a dialog for filtering data -> dependent functions are get_node_input_data, filter_data, add_data_viewer_tab, set_project_modified]
# [MainWindow.show_advanced_filter_dialog -> Shows an advanced dialog for filtering data -> dependent functions are add_data_viewer_tab, set_project_modified]
# [MainWindow.show_transformation_dialog -> Shows a dialog for data transformations -> dependent functions are add_data_viewer_tab, set_project_modified]
# [MainWindow.show_formula_editor -> Shows a dialog for creating new variables with formulas -> dependent functions are create_variable_from_formula]
# [MainWindow.create_variable_from_formula -> Creates a new variable from a formula -> dependent functions are create_formula_variable, add_data_viewer_tab, set_project_modified, update_action_states]
# [MainWindow.show_missing_values_dialog -> Shows a dialog for handling missing values -> dependent functions are handle_missing_values, add_data_viewer_tab, set_project_modified, update_action_states]
# [MainWindow.show_enhanced_formula_editor -> Shows an enhanced formula editor dialog -> dependent functions are add_data_viewer_tab, set_project_modified]
# [MainWindow.show_variable_selection_dialog -> Shows a dialog for selecting variables -> dependent functions are add_data_viewer_tab, set_project_modified]
# [MainWindow.show_categorical_grouping_dialog -> Shows a dialog for grouping categorical features -> dependent functions are add_data_viewer_tab, set_project_modified]
# [MainWindow.show_enhanced_tree_configuration_dialog -> Shows an enhanced dialog for configuring the tree -> dependent functions are set_project_modified]
# [MainWindow.show_manual_tree_growth_dialog -> Shows a dialog for manually growing the tree -> dependent functions are set_project_modified]
# [MainWindow.show_variable_importance_dialog -> Shows a dialog for variable importance analysis -> dependent functions are None]
# [MainWindow.show_performance_evaluation_dialog -> Shows a dialog for performance evaluation -> dependent functions are None]
# [MainWindow.show_node_reporting_dialog -> Shows a dialog for node reporting -> dependent functions are None]
# [MainWindow.show_tree_navigation_dialog -> Shows a dialog for navigating the tree -> dependent functions are select_node, highlight_path]
# [MainWindow.start_manual_tree_building -> Starts the manual tree building process -> dependent functions are connect_signals, set_tree, set_project_modified, update_action_states]
# [MainWindow.on_workflow_node_selected_on_canvas -> Handles node selection in the workflow canvas -> dependent functions are update_action_states]
# [MainWindow.on_tree_updated -> Handles the tree updated signal from the model -> dependent functions are set_tree]
# [MainWindow.on_node_updated -> Handles the node updated signal from the model -> dependent functions are update_node]
# [MainWindow.on_tree_node_selected -> Handles node selection in the tree visualizer -> dependent functions are None]
# [MainWindow.on_tree_node_selected_in_visualizer -> Handles node selection in the tree visualizer -> dependent functions are update_tree_visualization_after_node_edit]
# [MainWindow.on_tree_node_double_clicked -> Handles double-click events on a tree node -> dependent functions are update_tree_visualization_after_node_edit]
# [MainWindow.on_tree_node_right_clicked -> Handles right-click events on a tree node -> dependent functions are on_tree_node_double_clicked, edit_split_action, split_node_action, find_split_action, make_terminal_action, prune_subtree, copy_node_action, paste_node_action, delete_node_action]
# [MainWindow._export_metrics_report -> Exports a comprehensive metrics report -> dependent functions are export_metrics_report]
# [MainWindow._export_metrics_visualizations -> Exports metrics visualizations -> dependent functions are plot_confusion_matrix, plot_roc_curve, plot_metrics_summary]
# [MainWindow.manual_tree_building_mode -> Starts the manual tree building mode -> dependent functions are set_params, on_tree_node_selected, edit_node_split, show_enhanced_context_menu, set_tree]
# [MainWindow.edit_node_split -> Edits the split for a specific node -> dependent functions are set_tree]
# [MainWindow.show_node_context_menu -> Shows the context menu for a tree node -> dependent functions are show_node_statistics_for_id, edit_node_split, find_optimal_split, prune_subtree]
# [MainWindow.show_enhanced_context_menu -> Shows an enhanced context menu for a tree node -> dependent functions are show_for_node]
# [MainWindow.show_node_statistics_for_id -> Shows statistics for a specific node ID -> dependent functions are highlight_node, show_node_statistics]
# [MainWindow.find_optimal_split -> Finds the optimal split for a terminal node -> dependent functions are None]
# [MainWindow.prune_subtree -> Handles the prune subtree request from the context menu -> dependent functions are update_tree_visualization_after_node_edit, set_project_modified]
# [MainWindow.copy_node_action -> Copies a node and its entire subtree -> dependent functions are _serialize_node_subtree, _count_nodes_in_subtree]
# [MainWindow.paste_node_action -> Pastes a previously copied node as a child of another node -> dependent functions are _deserialize_node_subtree, update_tree_visualization_after_node_edit, set_project_modified]
# [MainWindow._serialize_node_subtree -> Serializes a node and its subtree for copying -> dependent functions are serialize_node, _count_nodes_in_subtree]
# [MainWindow._deserialize_node_subtree -> Deserializes and creates a new node subtree -> dependent functions are create_node_from_data]
# [MainWindow._count_nodes_in_subtree -> Counts the total number of nodes in a subtree -> dependent functions are _count_nodes_in_subtree]
# [MainWindow._generate_unique_node_id -> Generates a unique node ID for a copied node -> dependent functions are None]
# [MainWindow.split_node_action -> Handles the manual split node action from the context menu -> dependent functions are _on_split_applied_successfully, update_tree_visualization_after_node_edit]
# [MainWindow.find_split_action -> Handles the find split action from the context menu -> dependent functions are _apply_optimal_split]
# [MainWindow._apply_optimal_split -> Applies an optimal split selected from the find split dialog -> dependent functions are apply_manual_split, update_tree_visualization_after_node_edit, update_action_states]
# [MainWindow.edit_split_action -> Handles the edit split action from the context menu -> dependent functions are _on_split_modified, update_tree_visualization_after_node_edit]
# [MainWindow._on_split_modified -> Handles the split modification from the enhanced edit split dialog -> dependent functions are apply_manual_split, update_tree_visualization_after_node_edit]
# [MainWindow._open_enhanced_edit_split_dialog -> Opens the enhanced edit split dialog -> dependent functions are _get_current_model, apply_manual_split, _refresh_tree_visualizer]
# [MainWindow._on_split_configured -> Handle split configuration from new split configuration dialog -> dependent functions are apply_manual_split, update_tree_visualization_after_node_edit]
# [MainWindow._apply_found_split -> Applies a split found by the Find Split feature -> dependent functions are apply_manual_split, update_tree_visualization_after_node_edit]
# [MainWindow._on_split_applied_successfully -> Handles the successful application of a split from the streamlined dialog -> dependent functions are update_tree_visualization_after_node_edit, update_action_states]
# [MainWindow.make_terminal_action -> Handles the make terminal action from the context menu -> dependent functions are update_tree_visualization_after_node_edit]
# [MainWindow.delete_node_action -> Handles the delete node action from the context menu -> dependent functions are update_tree_visualization_after_node_edit]
# [MainWindow.update_tree_visualization_after_node_edit -> Updates the tree visualization after a node has been edited -> dependent functions are _safe_update_tree_visualization]
# [MainWindow._safe_update_tree_visualization -> Safely updates the tree visualization with error handling -> dependent functions are set_tree]
# [MainWindow.on_data_tab_changed -> Handles tab changes in the data tabs -> dependent functions are update_variable_viewer, update_action_states]
# [MainWindow.on_model_tab_changed -> Handles tab changes in the model tabs -> dependent functions are set_model]
# [MainWindow.on_tree_updated -> Handles the tree updated signal from the model -> dependent functions are set_tree]
# [MainWindow.on_node_updated -> Handles the node updated signal from the model -> dependent functions are update_node]
# [MainWindow.on_model_error -> Handles an error signal from the model -> dependent functions are None]
# [MainWindow.on_training_progress -> Handles the training progress signal from the model -> dependent functions are None]
# [MainWindow.on_training_complete -> Handles the training complete signal from the model -> dependent functions are None]
# [MainWindow.on_training_required -> Handles the training required signal from the model -> dependent functions are _find_model_node_id, trigger_workflow_rerun, run_workflow]
# [MainWindow._find_model_node_id -> Finds the workflow node ID that contains a given model instance -> dependent functions are None]
# [MainWindow.get_node_input_data -> Gets the input data for a node -> dependent functions are None]
# [MainWindow.update_action_states -> Enables or disables actions based on the current state -> dependent functions are None]
# [MainWindow.delete_selected_workflow_items -> Deletes selected items in the workflow canvas -> dependent functions are remove_node, set_project_modified]
# [MainWindow.set_project_modified -> Sets the project modified flag and updates the UI -> dependent functions are None]
# [MainWindow.check_unsaved_changes -> Checks for unsaved changes and prompts the user -> dependent functions are save_project]
# [MainWindow.closeEvent -> Handles the window close event -> dependent functions are check_unsaved_changes, save_application_state]
# [MainWindow.load_application_state -> Loads the application state from settings -> dependent functions are open_project]
# [MainWindow.save_application_state -> Saves the application state and settings -> dependent functions are saveGeometry, saveState]
# [MainWindow.load_recent_files -> Loads and populates the recent files menu -> dependent functions are open_recent_file, clear_recent_files]
# [MainWindow.remove_recent_file -> Removes a specific file from the recent files list -> dependent functions are load_recent_files]
# [MainWindow.add_recent_file -> Adds a file to the recent files list -> dependent functions are load_recent_files]
# [MainWindow.clear_recent_files -> Clears the recent files list -> dependent functions are load_recent_files]
# [MainWindow.show_preferences -> Shows the preferences dialog -> dependent functions are None]
# [MainWindow.show_help -> Shows the help contents -> dependent functions are get_config_value]
# [MainWindow.connect_model_signals -> Connects model signals to UI handlers -> dependent functions are on_tree_updated, on_node_updated, on_split_found, on_training_progress, on_training_complete, on_training_required, on_model_error]
# [MainWindow.train_model_from_workflow -> Trains a model from the workflow context -> dependent functions are get_node_input_data, fit, update_model_info]
# [MainWindow.evaluate_model_from_workflow -> Evaluates a model from the workflow context -> dependent functions are compute_metrics]
"""
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.latest_tree_models: Dict[str, BespokeDecisionTree] = {}
        self.visualization_node_context: Dict[str, Dict[str, Any]] = {}
        self.visualization_dependencies: Dict[str, Dict[str, Optional[str]]] = {}
    ...
    def on_workflow_node_double_clicked(self, workflow_node):
        ...
        try:
            ...
            viz_dependency = None
            if node_type in ["visualization", "viz"]:
                if not getattr(self, 'visualization_dependencies', None):
                    self._update_visualization_dependencies()
                viz_dependency = (self.visualization_dependencies or {}).get(node_id, {})
                dataset_descriptions: List[str] = []
                dataset_nodes = viz_dependency.get('dataset_node_ids') or []
                for ds_id in dataset_nodes:
                    ds_node = self.workflow_canvas.get_node_by_id(ds_id) if hasattr(self, 'workflow_canvas') else None
                    if ds_node:
                        ds_name = getattr(ds_node, 'dataset_name', None) or getattr(ds_node, 'title', None) or ds_id
                    else:
                        ds_name = ds_id
                    dataset_descriptions.append(f"{ds_id}:{ds_name}")
                dataset_info_str = ", ".join(dataset_descriptions) if dataset_descriptions else "none"
                model_info = viz_dependency.get('model_node_id') or "none"
                logger.info(
                    f"Node double-clicked: {node_id} (type: {node_type}) | model_node={model_info} | dataset_nodes={dataset_info_str}"
                )
            else:
            ...
            if node_type in ["dataset", "data"]:
                ...
                viz_context = self._get_visualization_context(node_id) or {}
                evaluation_results = viz_context.get('evaluation_results') or {}
                model_data = viz_context.get('model')
                tree_root = viz_context.get('tree_root')
                dataset = viz_context.get('dataset')
                if dataset is None:
                    dataset = getattr(self, 'current_dataset', None)
                dataset_label = viz_context.get('dataset_label') or self._resolve_dataset_label_for_visualization(
                    node_id, viz_context.get('evaluation_node_id')
                )
                target_column = viz_context.get('target_column')
                
                if not evaluation_results:
                    eval_results, _ = self._resolve_evaluation_results_for_visualization(node_id)
                    evaluation_results = eval_results or {}
                    if evaluation_results and not target_column:
                        target_column = evaluation_results.get(
                            'target_variable', evaluation_results.get('target_column')
                        )
                
                if model_data is None:
                    model_data = self._resolve_model_for_visualization(node_id)
                if model_data and tree_root is None:
                    tree_root = getattr(model_data, 'root', None)
                ...
                viz_info = {
                    ...
                    'target_column': target_column,
                    'evaluation_node_id': viz_context.get('evaluation_node_id'),
                    'model_node_id': viz_context.get('dependency_model_id'),
                    'dataset_nodes': viz_context.get('dataset_nodes', [])
                }
    ...
    def new_project(self, confirm_discard=True):
        ...
        self.visualization_node_context = {}
        self.visualization_dependencies = {}
        ...
        try:
            ...
            if success:
                ...
                if self.models:
                    ...
                    try:
                        for node_id, node in self.workflow_canvas.scene.nodes.items():
                            if isinstance(node, ModelNode) and hasattr(node, 'model') and node.model is not None:
                                self._rehydrate_model_cache_from_workflow(node, node.model)
                    except Exception as e:
                        logger.warning(f"Failed to rehydrate model caches after load: {e}")
                    ...
                    try:
                        for _mname, _model in self.models.items():
                            self.connect_model_signals(_model)
                    except Exception as e:
                        logger.warning(f"Could not connect signals for all models: {e}")
                    if hasattr(self, 'model_properties_widget') and self.model_properties_widget is not None:
    ...
    def _rehydrate_model_cache_from_workflow(self, model_node, model):
        """Rehydrate a model's cached training data from the dataset connected in the workflow.

        Ensures reloaded projects support manual split/edit and copy/paste by repopulating
        model._cached_X/_cached_y based on the connected DatasetNode.
        """
        try:
            scene = self.workflow_canvas.scene
            dataset_name = None
            for conn in scene.connections.values():
                try:
                    if (hasattr(conn, 'target_node_id') and conn.target_node_id == model_node.node_id and
                        hasattr(conn, 'source_node_id')):
                        src = scene.nodes.get(conn.source_node_id)
                        if src and hasattr(src, 'node_type') and getattr(src, 'node_type', '') == 'dataset':
            ...
            if not dataset_name or dataset_name not in self.datasets:
                logger.debug(f"No dataset found for ModelNode {model_node.node_id} during cache rehydrate")
                return
            ...
            if not hasattr(model, '_cached_X') or model._cached_X is None:
                model._cached_X = X.copy()
                model._cached_y = y.copy() if y is not None else None
                try:
                    if not getattr(model, 'feature_names', []):
                        model.feature_names = list(X.columns)
                except Exception:
                    pass
                model.training_samples = len(X)
                logger.info(f"Rehydrated model cache for '{getattr(model,'model_name',None)}' from dataset '{dataset_name}'")
        except Exception as e:
            logger.warning(f"Error rehydrating model cache: {e}")
    ...
    def show_import_wizard(self):
        ...
        if wizard.exec_() == DataImportWizard.Accepted:
            try:
                ...
                format_type = import_config.get('file_format', 'csv')
                date_columns = import_config.get('date_columns', [])
                date_format = import_config.get('date_format', '')
                selected_columns = import_config.get('usecols') or import_config.get('selected_columns')

                if format_type in ['csv', 'text']:
                    kwargs = {
                        'encoding': import_config.get('encoding', 'utf-8'),
                        'delimiter': import_config.get('delimiter', ','),
                        'quotechar': import_config.get('quotechar'),
                        'escapechar': import_config.get('escapechar'),
                        'header': import_config.get('header_row', 0),
                        'skiprows': import_config.get('skip_rows', 0),
                        'skipfooter': import_config.get('skip_footer', 0),
                        'decimal': import_config.get('decimal', '.'),
                        'thousands': import_config.get('thousands', ''),
                        'na_values': import_config.get('missing_values', []),
                        'date_columns': date_columns,
                        'date_format': date_format
                    }
                    if selected_columns:
                        kwargs['usecols'] = selected_columns
                elif format_type == 'excel':
                    kwargs = {
                        'sheet_name': import_config.get('sheet_name', 0),
                        'header': import_config.get('header_row', 0),
                        'skiprows': import_config.get('skip_rows', 0),
                        'skipfooter': import_config.get('skip_footer', 0),
                        'na_values': import_config.get('missing_values', []),
                ...
                if selected_columns and format_type not in ['csv', 'text', 'excel', 'parquet', 'feather']:
    ...
    def on_node_output_ready(self, node_id: str, output_data: Any, output_port_name: str):
        ...
        if isinstance(output_data, pd.DataFrame):
            ...
            try:
                ...
                if self.enhanced_status_bar:
                    self.enhanced_status_bar.show_message(
                        f"Evaluation from '{node_title}' completed - metrics cached."
                    )
            except Exception as e:
                logger.error(f"Error storing evaluation results: {e}", exc_info=True)
                if self.enhanced_status_bar:
                    self.enhanced_status_bar.show_error(
                        f"Evaluation from '{node_title}' completed with errors."
                    )
            ...
            context = self._collect_visualization_context(node_id, viz_type, data_ref)
            self.visualization_node_context[node_id] = context
            
            model_data = context.get('model')
            evaluation_results = context.get('evaluation_results')
            dataset_ref = context.get('dataset')
            if dataset_ref is None:
                dataset_ref = getattr(self, 'current_dataset', None)
            target_column = context.get('target_column')
            
            if model_data:
                self.latest_tree_models[node_id] = model_data
            if evaluation_results:
                self.latest_evaluation_results[node_id] = evaluation_results
            
            logger.info(f"Handling visualization trigger: type={viz_type}, data_ref={type(data_ref)}")
            
            if viz_type == 'tree' and isinstance(model_data, BespokeDecisionTree):
                if self.tree_viz_widget and model_data.is_fitted:
                    self.tree_viz_widget.set_tree(model_data.root)
                    if hasattr(self, 'model_tabs') and self.model_tabs:
                        for i in range(self.model_tabs.count()):
                            if self.model_tabs.tabText(i) == "Tree Visualizer":
                                self.model_tabs.setCurrentIndex(i)
                    ...
                    if evaluation_results:
                        viz_info = {
                            ...
                            'tree_root': getattr(model_data, 'root', None),
                            'dataset': dataset_ref,
                            'dataset_label': context.get('dataset_label'),
                            'target_column': target_column or evaluation_results.get('target_column', None),
                            'evaluation_node_id': context.get('evaluation_node_id'),
                            'model_node_id': context.get('dependency_model_id'),
                            'dataset_nodes': context.get('dataset_nodes', []),
                        }
                        QTimer.singleShot(500, lambda info=viz_info: self.window_manager.show_window('visualization', info))
            ...
            elif viz_type == 'metrics' and isinstance(evaluation_results, dict):
                if self.enhanced_status_bar:
                    self.enhanced_status_bar.show_message(f"Metrics from '{node_title}' stored for detail windows.")
            elif viz_type == 'tree' and isinstance(evaluation_results, dict):
                if self.enhanced_status_bar:
    ...
    def _collect_visualization_context(self, viz_node_id: str, viz_type: str, data_ref: Any) -> Dict[str, Any]:
        """
        Build a context dictionary for a visualization node so that downstream UI
        can render the correct model/metrics for that specific node.
        """
        dependency_info = self.visualization_dependencies.get(viz_node_id, {})
        context: Dict[str, Any] = {
            'node_id': viz_node_id,
            'viz_type': viz_type,
            'model': data_ref if isinstance(data_ref, BespokeDecisionTree) else None,
            'tree_root': getattr(data_ref, 'root', None) if isinstance(data_ref, BespokeDecisionTree) else None,
            'evaluation_results': data_ref if isinstance(data_ref, dict) and 'accuracy' in data_ref else None,
            'dataset': getattr(self, 'current_dataset', None),
            'target_column': None,
            'dataset_label': None,
            'dependency_model_id': dependency_info.get('model_node_id'),
            'dependency_evaluation_id': dependency_info.get('evaluation_node_id'),
            'dataset_nodes': dependency_info.get('dataset_node_ids', []),
        }
        
        if isinstance(context['evaluation_results'], dict):
            context['target_column'] = context['evaluation_results'].get(
                'target_column', context['evaluation_results'].get('target_variable')
        )
        
        eval_results, eval_node_id = self._resolve_evaluation_results_for_visualization(
            viz_node_id, context['evaluation_results']
        )
        if eval_results:
            context['evaluation_results'] = eval_results
            context['evaluation_node_id'] = eval_node_id
            context['target_column'] = context['target_column'] or eval_results.get(
                'target_column', eval_results.get('target_variable')
            )
            dataset_from_results = eval_results.get('dataset')
            if dataset_from_results is not None:
                context['dataset'] = dataset_from_results
            elif eval_results.get('dataframe') is not None:
                context['dataset'] = eval_results.get('dataframe')
            if not context['target_column']:
                context['target_column'] = eval_results.get('target_variable')
            if not context['dataset_label']:
                context['dataset_label'] = eval_results.get('dataset_label')
        
        model_data = self._resolve_model_for_visualization(viz_node_id, context['model'])
        if model_data:
            context['model'] = model_data
            context['tree_root'] = getattr(model_data, 'root', None)
        
        if not context['dataset_label']:
            context['dataset_label'] = self._resolve_dataset_label_for_visualization(
                viz_node_id, context.get('evaluation_node_id')
            )
        
        return context
    
    def _get_visualization_context(self, node_id: str) -> Optional[Dict[str, Any]]:
        """Return cached context for a visualization node, rebuilding it when needed."""
        if node_id in self.visualization_node_context:
            return self.visualization_node_context[node_id]
        
        viz_type = 'tree'
        data_ref = None
        
        try:
            node_obj = self.workflow_canvas.get_node_by_id(node_id)
            if node_obj and hasattr(node_obj, 'visualization_type'):
                viz_type = getattr(node_obj, 'visualization_type', viz_type)
        except Exception as e:
            logger.debug(f"Unable to inspect visualization node {node_id}: {e}")
        
        outputs = None
        if hasattr(self, 'workflow_engine') and self.workflow_engine:
            outputs = self.workflow_engine.get_all_node_outputs(node_id)
        
        if isinstance(outputs, dict) and 'Visualization Trigger' in outputs:
            payload = outputs['Visualization Trigger']
            if isinstance(payload, dict):
                viz_type = payload.get('type', viz_type)
    ...
    def _get_canvas_upstream_node_ids(self, node_id: str, connection_type: Optional[str] = None) -> List[str]:
        """Helper to safely query upstream node IDs from the workflow canvas."""
        try:
            if hasattr(self, 'workflow_canvas') and hasattr(self.workflow_canvas, 'get_upstream_node_ids'):
                return self.workflow_canvas.get_upstream_node_ids(node_id, connection_type)
        except Exception as e:
            logger.debug(f"Unable to query upstream nodes for {node_id}: {e}")
        return []
    
    def _update_visualization_dependencies(self):
        """Build a map of visualization nodes to their upstream model/evaluation nodes."""
        self.visualization_dependencies = {}
        try:
            if not hasattr(self, 'workflow_canvas') or not hasattr(self.workflow_canvas, 'scene'):
                return
            for node_id, node in getattr(self.workflow_canvas.scene, 'nodes', {}).items():
                if getattr(node, 'node_type', None) != NODE_TYPE_VISUALIZATION:
                    continue
                model_sources = self._get_canvas_upstream_node_ids(node_id, CONN_TYPE_MODEL)
                eval_sources = self._get_canvas_upstream_node_ids(node_id, CONN_TYPE_RESULT)
                dataset_sources: List[str] = []
                for eval_id in eval_sources:
                    dataset_sources.extend(self._get_canvas_upstream_node_ids(eval_id, CONN_TYPE_DATA))
                dataset_sources.extend(self._get_canvas_upstream_node_ids(node_id, CONN_TYPE_DATA))
                seen = set()
                dataset_sources = [ds for ds in dataset_sources if not (ds in seen or seen.add(ds))]
                self.visualization_dependencies[node_id] = {
                    'model_node_id': model_sources[0] if model_sources else None,
                    'evaluation_node_id': eval_sources[0] if eval_sources else None,
                    'dataset_node_ids': dataset_sources,
                }
            logger.debug("Visualization dependency map updated: %s", self.visualization_dependencies)
        except Exception as e:
            logger.error(f"Error updating visualization dependencies: {e}", exc_info=True)
    
    def _resolve_dataset_label_for_visualization(
        self,
        viz_node_id: str,
        eval_node_id: Optional[str] = None
    ) -> Optional[str]:
        """Best-effort attempt to describe which dataset feeds a visualization node."""
        try:
            candidate_ids: List[str] = []
            if hasattr(self, 'visualization_dependencies'):
                dep = self.visualization_dependencies.get(viz_node_id) or {}
                candidate_ids.extend(dep.get('dataset_node_ids') or [])
            if eval_node_id and eval_node_id not in candidate_ids:
                candidate_ids.extend(self._get_canvas_upstream_node_ids(eval_node_id, CONN_TYPE_DATA))
            candidate_ids.extend(self._get_canvas_upstream_node_ids(viz_node_id, CONN_TYPE_DATA))
            for dataset_node_id in candidate_ids:
                dataset_node = None
                if hasattr(self, 'workflow_canvas'):
                    dataset_node = self.workflow_canvas.get_node_by_id(dataset_node_id)
                if not dataset_node:
                    continue
                dataset_name = getattr(dataset_node, 'dataset_name', None)
                if dataset_name:
                    return dataset_name
                if hasattr(dataset_node, 'title') and dataset_node.title:
                    return dataset_node.title
        except Exception as e:
            logger.debug(f"Unable to resolve dataset label for visualization {viz_node_id}: {e}")
        return None
    
    def _resolve_evaluation_results_for_visualization(
        self,
        viz_node_id: str,
        candidate_results: Optional[Dict[str, Any]] = None
    ) -> Tuple[Optional[Dict[str, Any]], Optional[str]]:
        """Find evaluation results tied to a visualization node (directly or via upstream nodes)."""
        dependency_eval_id = self.visualization_dependencies.get(viz_node_id, {}).get('evaluation_node_id') \
            if hasattr(self, 'visualization_dependencies') else None
        if dependency_eval_id:
            cached = self.latest_evaluation_results.get(dependency_eval_id)
            if isinstance(cached, dict):
                return cached, dependency_eval_id
            if hasattr(self, 'workflow_engine') and self.workflow_engine:
                outputs = self.workflow_engine.get_all_node_outputs(dependency_eval_id)
                if outputs and 'Evaluation Results' in outputs:
                    eval_results = outputs['Evaluation Results']
                    if isinstance(eval_results, dict):
                        return eval_results, dependency_eval_id
        
        if isinstance(candidate_results, dict) and 'accuracy' in candidate_results:
            return candidate_results, viz_node_id
        
        if viz_node_id in self.latest_evaluation_results:
            results = self.latest_evaluation_results[viz_node_id]
            if isinstance(results, dict):
                return results, viz_node_id
        
        for eval_node_id in self._get_canvas_upstream_node_ids(viz_node_id, CONN_TYPE_RESULT):
            cached_results = self.latest_evaluation_results.get(eval_node_id)
            if isinstance(cached_results, dict):
                return cached_results, eval_node_id
            
            if hasattr(self, 'workflow_engine') and self.workflow_engine:
                outputs = self.workflow_engine.get_all_node_outputs(eval_node_id)
                if outputs and 'Evaluation Results' in outputs:
                    eval_results = outputs['Evaluation Results']
                    if isinstance(eval_results, dict):
                        return eval_results, eval_node_id
        
        return None, None
    
    def _resolve_model_for_visualization(
        self,
        viz_node_id: str,
        candidate_model: Optional[BespokeDecisionTree] = None
    ) -> Optional[BespokeDecisionTree]:
        """Find the decision tree model instance that feeds a visualization node."""
        dependency_model_id = self.visualization_dependencies.get(viz_node_id, {}).get('model_node_id') \
            if hasattr(self, 'visualization_dependencies') else None
        
        def _lookup_model(node_id: str) -> Optional[BespokeDecisionTree]:
            if not node_id or not hasattr(self, 'workflow_engine') or not self.workflow_engine:
                return None
            model_obj = self.workflow_engine.get_node_output(node_id, 'Model Output')
            if isinstance(model_obj, BespokeDecisionTree):
                return model_obj
            return None
        
        if dependency_model_id:
            model_obj = _lookup_model(dependency_model_id)
            if model_obj:
                return model_obj
        
        if isinstance(candidate_model, BespokeDecisionTree):
            return candidate_model
        
        model_from_cache = self.latest_tree_models.get(viz_node_id)
        if isinstance(model_from_cache, BespokeDecisionTree):
            return model_from_cache
        
        for model_node_id in self._get_canvas_upstream_node_ids(viz_node_id, CONN_TYPE_MODEL):
            model_obj = _lookup_model(model_node_id)
            if model_obj:
                return model_obj
        
        for eval_node_id in self._get_canvas_upstream_node_ids(viz_node_id, CONN_TYPE_RESULT):
            for model_node_id in self._get_canvas_upstream_node_ids(eval_node_id, CONN_TYPE_MODEL):
                model_obj = _lookup_model(model_node_id)
                if model_obj:
                    return model_obj
...
<p><i>AUC Score: {}</i></p>""".format(evaluation_results.get('roc_auc', 'N/A')))
    ...
    def _normalize_split_config_for_application(self, split_config: Dict[str, Any]) -> Dict[str, Any]:
        """Flatten split candidates so the model receives the expected schema."""
        if not isinstance(split_config, dict):
            return split_config

        prepared = deepcopy(split_config)
        nested_info = prepared.pop('split_info', None)

        if isinstance(nested_info, dict):
            normalized = deepcopy(nested_info)
            for key, value in prepared.items():
                normalized.setdefault(key, value)
        else:
            normalized = prepared

        split_type = str(normalized.get('split_type', '')).lower()
        if split_type.startswith('numeric'):
            threshold = (
                normalized.get('threshold')
                or normalized.get('split_value')
                or normalized.get('value')
            )

            if threshold is None and isinstance(nested_info, dict):
                threshold = (
                    nested_info.get('threshold')
                    or nested_info.get('split_value')
                    or nested_info.get('value')
                )
            ...
            if threshold is not None:
                try:
                    ...
                    threshold_value = threshold  # Leave as-is; model will validate

                normalized['threshold'] = threshold_value
                normalized['split_value'] = threshold_value
    ...
    def _apply_optimal_split(self, node_id: str, split_config: Dict[str, Any]):
        ...
        try:
            if self.current_model_name and self.current_model_name in self.models:
                ...
                normalized_config = self._normalize_split_config_for_application(split_config)
                
                success = model.apply_manual_split(node_id, normalized_config)
    ...
    def _apply_found_split(self, node_id: str, split_info: dict):
        ...
        try:
            if self.current_model_name and self.current_model_name in self.models:
                ...
                normalized_config = self._normalize_split_config_for_application(split_info)
                ...
                if success:
                    ...
                    feature = normalized_config.get('feature', 'unknown')
                    split_type = normalized_config.get('split_type', 'unknown')
