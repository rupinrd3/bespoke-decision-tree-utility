...
[VariableViewerWidget.__init__ -> Initializes the widget for displaying variable information -> dependent functions are None]
[VariableViewerWidget.update_variables -> Updates the view with variables from a DataFrame -> dependent functions are None]
[VariableViewerWidget.clear -> Clears the variable view -> dependent functions are None]
"""
