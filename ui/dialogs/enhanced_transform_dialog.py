...
[TransformationLogic.__init__ -> Initializes the TransformationLogic -> dependent functions are None]
[TransformationLogic.apply_transformations -> Applies a list of transformations to a DataFrame -> dependent functions are _apply_single_transformation]
[TransformationLogic._apply_single_transformation -> Applies a single transformation -> dependent functions are _create_interaction_term, _create_polynomial_features, _apply_log_transform, _apply_standardization, _apply_normalization, _apply_binning, _apply_one_hot_encoding, _handle_missing_values]
[TransformationLogic._create_interaction_term -> Creates an interaction term -> dependent functions are None]
[TransformationLogic._create_polynomial_features -> Creates polynomial features -> dependent functions are None]
[TransformationLogic._apply_log_transform -> Applies a log transform -> dependent functions are None]
[TransformationLogic._apply_standardization -> Applies standardization -> dependent functions are None]
[TransformationLogic._apply_normalization -> Applies normalization -> dependent functions are None]
[TransformationLogic._apply_binning -> Applies binning -> dependent functions are None]
[TransformationLogic._apply_one_hot_encoding -> Applies one-hot encoding -> dependent functions are None]
[TransformationLogic._handle_missing_values -> Handles missing values -> dependent functions are None]
[EnhancedTransformDialog.__init__ -> Initializes the EnhancedTransformDialog -> dependent functions are setup_ui, load_initial_state]
[EnhancedTransformDialog.setup_ui -> Sets up the user interface -> dependent functions are _create_left_panel, _create_right_panel, _create_button_bar]
[EnhancedTransformDialog._create_left_panel -> Creates the left panel -> dependent functions are _add_transformation_to_list, _remove_selected_transformation, _move_transformation_up, _move_transformation_down]
[EnhancedTransformDialog._create_right_panel -> Creates the right panel -> dependent functions are _update_preview]
[EnhancedTransformDialog._create_button_bar -> Creates the button bar -> dependent functions are apply_changes, reject]
[EnhancedTransformDialog.load_initial_state -> Loads the initial state of the dialog -> dependent functions are _add_transformation_to_list]
[EnhancedTransformDialog._add_transformation_to_list -> Adds a transformation to the list -> dependent functions are None]
[EnhancedTransformDialog._remove_selected_transformation -> Removes the selected transformation -> dependent functions are _update_preview]
[EnhancedTransformDialog._move_transformation_up -> Moves the selected transformation up -> dependent functions are _update_preview]
[EnhancedTransformDialog._move_transformation_down -> Moves the selected transformation down -> dependent functions are _update_preview]
[EnhancedTransformDialog._update_preview -> Updates the data preview -> dependent functions are None]
[EnhancedTransformDialog.apply_changes -> Applies the changes -> dependent functions are None]
"""
