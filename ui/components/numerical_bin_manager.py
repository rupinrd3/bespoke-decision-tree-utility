...
[EnhancedNumericalBinManager.__init__ -> Initializes the EnhancedNumericalBinManager -> dependent functions are init_ui, _delayed_update_statistics]
[EnhancedNumericalBinManager.init_ui -> Initializes the user interface -> dependent functions are on_num_bins_changed, set_precision, set_auto_adjust, create_equal_width_bins, create_equal_frequency_bins, add_bin, remove_selected_bin, on_table_item_changed]
[EnhancedNumericalBinManager.load_data -> Loads data for bin management -> dependent functions are create_equal_width_bins]
[EnhancedNumericalBinManager.set_precision -> Sets decimal precision for boundaries -> dependent functions are _populate_bins_table]
[EnhancedNumericalBinManager.set_auto_adjust -> Enables/disables automatic adjustment -> dependent functions are None]
[EnhancedNumericalBinManager.set_num_bins -> Sets the number of bins -> dependent functions are None]
[EnhancedNumericalBinManager.on_num_bins_changed -> Handles bin count changes -> dependent functions are create_equal_width_bins]
[EnhancedNumericalBinManager.create_equal_width_bins -> Creates equal width bins -> dependent functions are _populate_bins_table, schedule_statistics_update]
[EnhancedNumericalBinManager.create_equal_frequency_bins -> Creates equal frequency bins -> dependent functions are _populate_bins_table, schedule_statistics_update]
[EnhancedNumericalBinManager.create_quantile_bins -> Creates quantile-based bins -> dependent functions are create_equal_frequency_bins]
[EnhancedNumericalBinManager.add_bin -> Adds a new bin -> dependent functions are _populate_bins_table, schedule_statistics_update]
[EnhancedNumericalBinManager.remove_selected_bin -> Removes the selected bin -> dependent functions are _auto_adjust_after_removal, _populate_bins_table, schedule_statistics_update]
[EnhancedNumericalBinManager._auto_adjust_after_removal -> Auto-adjusts bins after removal -> dependent functions are None]
[EnhancedNumericalBinManager.on_table_item_changed -> Handles manual table edits -> dependent functions are _handle_min_value_change, _handle_max_value_change]
[EnhancedNumericalBinManager._handle_min_value_change -> Handles minimum value changes -> dependent functions are _repopulate_table_row, _populate_bins_table, schedule_statistics_update]
[EnhancedNumericalBinManager._handle_max_value_change -> Handles maximum value changes -> dependent functions are _repopulate_table_row, _populate_bins_table, schedule_statistics_update]
[EnhancedNumericalBinManager._repopulate_table_row -> Repopulates a single table row -> dependent functions are on_table_item_changed]
[EnhancedNumericalBinManager._populate_bins_table -> Populates the bins table -> dependent functions are on_table_item_changed]
[EnhancedNumericalBinManager.schedule_statistics_update -> Schedules a delayed statistics update -> dependent functions are None]
[EnhancedNumericalBinManager._delayed_update_statistics -> Performs a delayed update -> dependent functions are update_statistics]
[EnhancedNumericalBinManager.update_statistics -> Updates bin statistics -> dependent functions are get_background_calculator, _calculate_statistics_sync]
[EnhancedNumericalBinManager._calculate_statistics_sync -> Synchronous statistics calculation fallback -> dependent functions are None]
[EnhancedNumericalBinManager._on_statistics_calculated -> Handles calculated statistics -> dependent functions are None]
[EnhancedNumericalBinManager.get_bin_definitions -> Gets the current bin definitions -> dependent functions are None]
[EnhancedNumericalBinManager.get_bin_count -> Gets the current number of bins -> dependent functions are None]
[EnhancedNumericalBinManager.validate_bins -> Validates the bin configuration -> dependent functions are None]
[EnhancedNumericalBinManager.on_bin_value_changed -> Handles bin value changes with debounced validation -> dependent functions are _perform_debounced_validation]
[EnhancedNumericalBinManager._perform_debounced_validation -> Performs validation after a debounce delay -> dependent functions are _validate_all_bins]
[EnhancedNumericalBinManager._validate_all_bins -> Validates all bins and returns a list of errors -> dependent functions are None]
[EnhancedNumericalBinManager.get_bin_configuration -> Gets the current bin configuration in a standard format -> dependent functions are None]
"""
